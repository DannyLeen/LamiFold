...
class CylindricalCommand(apper.Fusion360CommandBase):
    ...
    def on_preview(self, command: adsk.core.Command, inputs: adsk.core.CommandInputs, args, input_values):
        ...
        if len(all_selections) > 0:
            ...
            state = self.drawRotateLayers(input_values)            
            text_box_input.text = state
               
        topLayer = ao.design.allComponents.itemByName("TopLayer PartA")
        if topLayer:
    ...
    def on_create(self, command: adsk.core.Command, inputs: adsk.core.CommandInputs):
       ...
       # default_offsetX = adsk.core.ValueInput.createByString('20 mm')
        ...
        tab1ChildInputs.addBoolValueInput('checkDebug_input_id', 'Debug', True, '', True)
        ...
        inputs.addTextBoxCommandInput('text_box_input_id', 'State: ', '', 1, True)

    def drawRotateLayers(self, input_values):
        ao = AppObjects()
        # Input value -->
